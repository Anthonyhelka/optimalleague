class Api::V1::LeagueController < ApplicationController
  def fcs
    ...
    render json: { min_rank: league.min_rank, max_rank: league.max_rank, standings_url: league.standings_url, stats_url: league.stats_url, teams: teams, players: JSON.parse(players) }
  end
